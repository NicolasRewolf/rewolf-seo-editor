/**
 * Prompts dédiés à la rédaction SEO et à l'assistant d'écriture.
 */
...
/**
 * Alias de compatibilité avec les constantes nommées côté client historique.
 */
export const SEO_WRITING_SYSTEM_PROMPT = SEO_WRITING_PROMPT;
export const SEO_EDITOR_SYSTEM_PROMPT = SEO_EDITOR_PROMPT;
