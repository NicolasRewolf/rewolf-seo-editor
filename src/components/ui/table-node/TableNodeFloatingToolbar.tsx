...
import { useEditorPlugin, useEditorRef, useEditorSelector, useElement, useFocusedLast, useRemoveNodeButton, useSelected } from 'platejs/react';
...
import { TABLE_MULTI_SELECTION_TOOLBAR_DELAY_MS } from './useTableNode';

export function TableNodeFloatingToolbar({
  children,
  ...props
...
function ExpandedSelectionTableFloatingToolbarContent(
  ...
  return (
    <TableNodeFloatingToolbarContent
      canMerge={canMerge}
      canSplit={canSplit}
...
function TableNodeFloatingToolbarContent({
  buttonProps,
  canMerge = false,
  canSplit = false,
